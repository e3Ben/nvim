local isLspConfigReady, lspconfig = pcall(require, 'lspconfig')
local pid = vim.fn.getpid()
local os = require('os')

if not isLspConfigReady then
...
-- "https://github.com/OmniSharp/omnisharp-roslyn/releases/download/v1.39.2/omnisharp-linux-x64-net6.0.tar.gz"
